  ...
  return (
    <div className="min-h-screen bg-background" lang={i18n.language}>
      ...
      <main id="main-content" className="overflow-x-clip" tabIndex={-1}>
            ...
            >
              {features.map((feature, index) => (
                <Card
                  key={index}
                  role="listitem"
                  className={`group relative overflow-hidden border-border/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 bg-card/50 backdrop-blur-sm ${feature.hoverBg} ${feature.size === "large"
        ...
        <PublicFooter onNavigateToSection={scrollToSection} />
      </main>
