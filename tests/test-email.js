...
console.log(
  `   VITE_FRONTEND_URL: ${process.env.VITE_FRONTEND_URL || "nicht gesetzt"}`,
);
...
Dein Sportify-Team`;
      ...
      return {
        emailHtml,
        emailBody,
        subject: "Sportify – Neuer persönlicher Rekord!",
      };
    }
...
Dein Sportify-Team`;
    ...
    default: {
      ...
      const emailHtml = createActionEmail({
        ...
        message:
          "Das ist eine Test-E-Mail um zu überprüfen, ob das E-Mail-System und die Templates korrekt funktionieren.",
        buttonText: "Zur Sportify App",
        buttonUrl: frontendUrl,
        additionalText:
          "Diese Test-E-Mail wurde automatisch generiert mit Inline-Styles für maximale E-Mail-Client-Kompatibilität.",
        frontendUrl,
        preheader: "E-Mail Test",
      });

      const emailBody =
        "Das ist eine Test-E-Mail. Wenn du HTML siehst, funktioniert das Template-System!";
