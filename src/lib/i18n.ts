  ...
  de: {
    translation: {
      ...
      changelog: {
        ...
        entries: {
          v212: {
            ...
            description:
              "Neue Schnellnavigation per Tastenkürzel: Mit einem Klick zu allen wichtigen Bereichen, Vorlagen, Freunden – und Einstellungen direkt in der Palette anpassen.",
            highlights: {
              0: "Öffnen: ⌘K (Mac) bzw. Strg+K (Windows/Linux) – die Palette erscheint zentral und durchsuchbar",
              1: "Navigation: Direkt zu Dashboard, Rangliste (Freunde/Global), vergangene Workouts, Statistiken, Changelog",
              2: "Training: Eigenes Training starten, Training aus Vorlage (Vorlagenliste), Erholungstagebuch",
              3: "Einstellungen in der Palette: Sprache, Theme (Hell/Dunkel/System), Zeitformat, Gewicht/Distanz/Temperatur-Einheiten, Push- und E-Mail-Benachrichtigungen – sofort umschaltbar ohne Profil zu öffnen",
              4: "Übungen, Social & mehr: Übung erstellen/durchsuchen, Freunde und Aktivitäten, Profil; Schnellzugriff auf Freunde-Liste und (für Admins) Admin-Bereiche; auf Deutsch und Englisch",
            },
          },
          v210: {
      ...
      commandPalette: {
        ...
        defaultTemplateTitle: "Vorlage",
        unknownFriend: "?",
        languageDe: "Deutsch",
        languageEn: "Englisch",
        shortcutMac: "⌘K",
        shortcutWin: "Strg+K",
        dialogTitle: "Befehlspalette",
        dialogDescription: "Suche nach Seiten und Aktionen",
        groups: {
          navigation: "Navigation",
          training: "Training",
          exercises: "Übungen",
        ...
        items: {
          dashboard: "Dashboard",
          scoreboardFriends: "Rangliste Freunde",
          scoreboardGlobal: "Rangliste Global",
          startTraining: "Training starten",
          trainingFromTemplate: "Training aus Vorlage",
          ownTraining: "Eigenes Training",
          pastWorkouts: "Vergangene Workouts",
          recoveryDiary: "Erholungstagebuch",
          ...
          inviteFriends: "Freunde einladen",
          profile: "Profil",
          unitPreferences: "Einheitenpräferenzen",
          ...
          tempCelsius: "Temperatur: °C",
          tempFahrenheit: "Temperatur: °F",
          adminOverview: "Admin: Übersicht",
          adminUsers: "Admin: Benutzerverwaltung",
          adminExercises: "Admin: Übungsverwaltung",
          adminModeration: "Admin: Moderation",
          adminMonitoring: "Admin: Monitoring",
          back: "Zurück",
          on: "An",
          off: "Aus",
          friendsActivity: "Freunde Aktivitäten",
        },
      },
    },
  },
  en: {
    translation: {
      ...
      changelog: {
        ...
        entries: {
          v212: {
            ...
            description:
              "New quick navigation via keyboard shortcut: Jump to all main areas, templates and friends – and change settings directly in the palette.",
            highlights: {
              0: "Open: ⌘K (Mac) or Ctrl+K (Windows/Linux) – the palette appears in the center and is searchable",
              1: "Navigation: Direct links to dashboard, scoreboard (friends/global), past workouts, statistics, changelog",
              2: "Training: Start custom training, training from template (template list), recovery diary",
              3: "Settings in the palette: Language, theme (light/dark/system), time format, weight/distance/temperature units, push and email notifications – switch instantly without opening profile",
              4: "Exercises, social & more: Create/browse exercises, friends and activity feed, profile; quick access to friends list and (for admins) admin sections; available in German and English",
            },
          },
          v210: {
      ...
      commandPalette: {
        ...
        dialogDescription: "Search for pages and actions",
        groups: {
          navigation: "Navigation",
          training: "Training",
          exercises: "Exercises",
        ...
        items: {
          dashboard: "Dashboard",
          scoreboardFriends: "Scoreboard Friends",
          scoreboardGlobal: "Scoreboard Global",
          startTraining: "Start Training",
          trainingFromTemplate: "Training from Template",
          ownTraining: "Custom Training",
          ...
          adminExercises: "Admin: Exercise Management",
          adminModeration: "Admin: Moderation",
          adminMonitoring: "Admin: Monitoring",
          back: "Back",
          on: "On",
          off: "Off",
          friendsActivity: "Friends Activities",
        },
      },
    },
  },
