  ...
  de: {
    translation: {
      ...
      weeklyChallenge: {
        ...
        noFriendsYet: "Du hast noch keine Freunde. Füge Freunde hinzu, um sie hier zu sehen.",
      },
      // Weekly Goals
      weeklyGoals: {
      ...
      scoreboard: {
        ...
        stats: {
          ...
          recoveryTrendDescription: "Verfolge deine Energie, Schlafqualität und Belastung im Verlauf.",
          noRecoveryData: "Keine Einträge im Erholungstagebuch für diesen Zeitraum.",
          ...
          analyticsErrorDescription: "Beim Laden der Analysedaten ist ein Fehler aufgetreten.",
      ...
      stats: {
        ...
        notEnoughData: "Für diese Analyse sind noch nicht genug Daten vorhanden.",
  ...
  en: {
    translation: {
      ...
      weeklyChallenge: {
        ...
        noFriendsYet: "You don't have any friends yet. Add friends to see them here.",
      },
      // Weekly Goals
      weeklyGoals: {
      ...
      scoreboard: {
        ...
        stats: {
          ...
          recoveryTrendDescription: "Track energy, sleep quality and exertion over time.",
          ...
          analyticsErrorDescription: "An error occurred while loading analytics data.",
          retry: "Try again",
    ...
    stats: {
      ...
      restingHeartRate: "Resting heart rate",
      recoveryTrend: "Recovery trend",
      recoveryTrendDescription: "Track your energy, sleep quality, and exertion over time.",
      ...
      correlationDescription: "See which recovery metrics move with your training load.",
