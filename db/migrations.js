...
export const ensureAllTablesExist = async (pool) => {
    const requiredTables = {
        ...
        'workouts': ['id', 'user_id', 'title', 'start_time', 'duration', 'use_end_time', 'difficulty', 'session_type', 'rounds', 'rest_between_sets_seconds', 'rest_between_activities_seconds', 'rest_between_rounds_seconds', 'category', 'discipline', 'movement_pattern', 'movement_patterns', 'visibility', 'is_template', 'created_at'],
